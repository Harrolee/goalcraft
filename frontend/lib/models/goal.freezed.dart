...
class _$GoalImpl implements _Goal {
  ...
  @override
  String toString() {
    return 'Goal(id: $id, userId: $userId, title: $title, description: $description, targetDate: $targetDate, milestones: $milestones, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, userId, title, description,
      targetDate, const DeepCollectionEquality().hash(_milestones), createdAt);
